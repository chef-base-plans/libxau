title 'Tests to confirm libxau library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'libxau')

control 'core-plans-libxau-library-exists' do
  impact 1.0
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xau.pc')
